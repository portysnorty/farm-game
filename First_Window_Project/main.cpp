...
int main(){
    ...
    music_jazz= Mix_LoadMUS("Jazz.mp3");
    Mix_PlayMusic(music_jazz, -1);
                ...
                switch(whichAnimal){
                    ...
                    case(0):
                        if(((x>=1000)&&(x<=1121)) && ((y>=530)&&(y<=730))){
                            is_click = true;
                            image_surface = SDL_LoadBMP("First.bmp");
                        }else{
                    ...
                    case(1):
                        if(((x>=0)&&(x<=65)) && ((y>=530)&&(y<=730))){
                            is_click = true;
                            image_surface = SDL_LoadBMP("Half_Way.bmp");
                        }else{
                            cout<<"\nThat is not "<<the_animal->name<<".\n";
                    ...
                    case(2):
                        if(((x>=325)&&(x<=440)) && ((y>=285)&&(y<=335))){
                            is_click = true;
                            image_surface = SDL_LoadBMP("3_Progress.bmp");
                        }else{
                            cout<<"\nThat is not "<<the_animal->name<<".\n";
                            cout<<"is_click\n";
                    ...
                    case(3):
                        if(((x>=1670)&&(x<=1715)) && ((y>=111)&&(y<=143))){
                            is_click = true;
                            image_surface = SDL_LoadBMP("Full_Progress.bmp");
                        }else{
                            cout<<"\nThat is not "<<the_animal->name<<".\n";
                            cout<<"DIE\n";
                            cout<<"DIE\n";
